...
$AZ_BIN group create --name $RESOURCE_GROUP --location $LOCATION

# Step 3: Create Azure Container Registry (ACR)
echo "🏗️ Step 2/5: Creating Azure Container Registry ($ACR_NAME)..."
$AZ_BIN acr create --resource-group $RESOURCE_GROUP --name $ACR_NAME --sku Basic --admin-enabled true
...
$AZ_BIN appservice plan create --name $APP_SERVICE_PLAN --resource-group $RESOURCE_GROUP --is-linux --sku B1
